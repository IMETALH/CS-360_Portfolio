package com.kennedy.CS360_Weight_Tracker;
...
import com.kennedy.CS360_Weight_Tracker.database.DailyWeightDao;
import com.kennedy.CS360_Weight_Tracker.database.WeightTrackerDatabase;
    ...
    public void deleteButtonOnClick(View view) {
        try {
            ...
            if (existingRecord == null) {
                mPrompt.setText("DATE NOT FOUND");
                mPrompt.setTextColor(Color.RED);
                return;
            }

            // change widget properties so user can confirm the deletion
            mPrompt.setText("ARE YOU SURE YOU WANT TO DELETE THE RECORD?");
            mPrompt.setTextColor(Color.RED);
